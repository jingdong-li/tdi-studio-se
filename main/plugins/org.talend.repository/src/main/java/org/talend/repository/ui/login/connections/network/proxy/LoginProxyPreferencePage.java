 ...
 */
public class LoginProxyPreferencePage extends PreferencePage {

    private Label providerLabel;

    protected Combo providerCombo;

    private LoginProxyEntriesComposite proxyEntriesComposite;

    private LoginNonProxyHostsComposite nonProxyHostsComposite;
    ...
    private void createProxyEntriesComposite(Composite parent) {
        proxyEntriesComposite = new LoginProxyEntriesComposite(parent, SWT.NONE);
    ...
    private void createNonProxiedHostsComposite(Composite parent) {
        nonProxyHostsComposite = new LoginNonProxyHostsComposite(parent, SWT.NONE);
